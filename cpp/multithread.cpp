...
long int parallel_primes(float end_power) {
...
int main() {
  ...
  vector<vector<string>> outvec = benchmark_series(1,9,.1,num_iter);
  int status = write_result_vector(outvec,"../data/cpp_multi.csv");
  return 0;
}
